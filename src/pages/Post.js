    ...
    return (
        <>
            ...
            <div className="groupInput">
                <h2>Cover Image</h2>
                <input className="input" type="file" id="imageLoader" name="imageLoader" onChange={handleImageUpload} />
            </div>
            <div className="groupInput">
                <h2>Title</h2>
                <textarea className="input" rows="4" value={title} onChange={(e) => setTitle(e.target.value)} />
            </div>
            <div className="groupInput">
                <h2>Category</h2>
            ...
            <div className="groupInput">
                <button disabled={isTitleButtonDisabled} onClick={() => handleDownload('canvas-cover')}>
                    Download Cover
                </button>
                <button disabled={isContentButtonDisabled} onClick={() => handleDownload('canvas-content')}>
                    Download Content
                </button>
            </div>
            <div className="groupInput">
                {isContentButtonDisabled && (
                    <p className="warning">Your content is too long, please reduce to have less lines</p>
                )}
                {isTitleButtonDisabled && (
                    <p className="warning">Your title is too long, please reduce to have less lines</p>
                )}
            </div>
        </>
    );
